...
- [Fixed] Linked folders now reach Codex under the OD Next strategy through `OD_LINKED_DIRS`, a JSON object keyed by the `linked-dir:N` aliases the prompt already names. (#issue TBD)
